...
export class CustomerService extends BaseService {
  constructor(private httpClient: HttpClient) {
    ...
    CustomerVehiclesPing(): Observable<ApiResponse> {
      return this.get(API_CONSTANTS.CustomerVehiclesPing);
    }
  GetCurrentCustomer(): Observable<ApiResponse> {
    return this.get(API_CONSTANTS.GetCurrentCustomer);
    }
